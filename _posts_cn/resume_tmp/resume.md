...
> 2019.08 - 至今 **网心研发工程师** ***云计算产品部***
> 2018.03 - 2019.07  **百度研发工程师** ***智能云物联网部门/边缘计算***
...
- **项目目的：** 公司处于初创阶段，线上机器资源申请与实际使用情况并不匹配，导致机器资源浪费，搭建 Paas 平台一方面有利于线上机器资源管理，另一方面可以节省服务扩展及部署精力
- **项目难点：** 由于公司之前业务后台多为 PHP 开发，使用容器部署到 K8S 集群并提供给外部访问相对较为困难，需要进行合理的容器设计
- **项目角色：** 参与项目总体设计，协调、参与平台研发
- **工作内容：**
  1. 负责前后端研发协调工作
  2. 参与 PAAS 平台总体设计
  3. 负责整体流程跑通
...
> Golang、Rust、C++、常见深度学习框架 (如: Tensorflow/Pytorch/Caffee/Keras) 等。
...
> Java、Spring、Javascript、NodeJs、React 等。
...
- 对于项目的设计思想及关键功能的实现较为感兴趣，比如 K8S、Redis、Docker等
- 性格较为活泼、容易相处