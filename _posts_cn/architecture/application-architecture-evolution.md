...
![cloud-native compositions](https://sherlockblaze.com/resources/img/architecture/cloud-native-composition.png)

如上图所示，分析 Cloud Native 需要从架构、研发流程、团队文化三个角度来实现，三者需要相互配合，缺一不可。

**架构角度**： Cloud Native 是以云和微服务架构作为基础构建系统的。Cloud Native 架构的组成大致如下图所示：

![could-native architectural composition](https://sherlockblaze.com/resources/img/architecture/cloud-native-architectural-composition.png)
